...
- [3. Libros de software](#3-libros-de-software)
    ...
    - [3.2 Estructuras de datos y algoritmos](#32-estructuras-de-datos-y-algoritmos)
...
| Portada | Descripción |
| --- | --- |
| ![The Art of Computer Programming](images/books/software/the-art-of-computer-programming.jpg) | **Nombre:** The Art of Computer Programming <br> **Autor:** [Donald E. Knuth](https://www-cs-faculty.stanford.edu/~knuth/) <br><br> Es un libro clásico en lo referente al análisis de algoritmos y estructuras de datos fundamentales. Acá la dificultad sube bastante con respecto a los anteriores libros. Su contenido es mucho más tecnico que los anteriores libros, por lo que es más dificil de digerir. <br> Es bastante denso (posee 7 volúmenes), por lo que requiere de bastante tiempo de dedicación... varios años diría yo. Es básica una biblia en lo referente a DSA, muy recomendado si quieres profundizar en ellos desde un punto de vista teórico.<br> |
